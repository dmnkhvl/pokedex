...
export default function Home({ loaderData }: Route.ComponentProps) {
  ...
  return (
    <section className="mx-auto sm:max-w-[640px] md:w-full lg:max-w-4xl xl:max-w-full flex flex-col gap-y-4 sm:gap-y-6 px-8 sm:px-4 py-8 min-h-screen ">
      <h1 className="text-6xl md:text-8xl uppercase">Pokédex</h1>
